...
function drawBasic() {
  ...
  if ($("#combo-chart").length > 0) {
      var data = google.visualization.arrayToDataTable([
        ['Month', 'Indonesia', 'Malaysia', 'Singapore', 'Vietnam', 'Thailand', 'Average'],
        ['2016/05',  1500,      938,         522,             998,           450,      614.6],
        ['2017/06',  1600,      1120,        599,             1268,          288,      682],
        ['2018/07',  1700,      1167,        587,             807,           397,      623],
        ['2019/08',  1800,      1110,        615,             968,           215,      609.4],
        ['2020/09',  1900,      691,         629,             1026,          366,      569.6]
      ]);
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: ["darkred", "lightblue", "#fe80b2", "#80cf00", "#fd517d"]
    };
  ...
  if ($("#area-chart2").length > 0) {
    var data = google.visualization.arrayToDataTable([
      ...
      ['2017',  100, 400, 2000, 400],
      ['2018',  500, 700, 530, 800],
      ['2019',  2000, 1000, 620, 120],
      ['2020',  120, 201, 2501, 540]
    ]);
    var options = {
      title: 'Company Performance',
      hAxis: {title: 'Year',  titleTextStyle: {color: '#333'}},
