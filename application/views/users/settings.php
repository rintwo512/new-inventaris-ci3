          ...
          <div class="container-fluid">
            <div class="edit-profile">
              <div class="row">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form class="theme-form" method="post" action="<?=base_url('settings/updatePassword') ?>">
                        ...
                        <div class="form-group">
                          <label class="form-label" for="new_password_conf">Konfimasi password</label>
                ...
                <div class="col-lg-8 mt-5 mb-5" style="background-color: white">                  
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                          <div class="form-group">
                            <label class="form-label mb-0" for="nik">NIK</label>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-11">
                              <div class="row">
                                  <div class="col-sm-6">
                                      <img style="margin-bottom:10px" src="<?= base_url('assets/img/') .$user['image']; ?>" class="img-thumbnail" id="uploaded_image" width="150">
