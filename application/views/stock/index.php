                      ...
                      <table class="hover" id="example-style-4">
                        ...
                        <?php foreach($listBarang as $list) : ?>                       
                          <tr>
                            ...
                            <td><span class="badge badge-success"><?=$list['status'];?></span></td> <?php elseif ($list['status'] == 'rusak') : ?>
                            <td><span class="badge badge-warning"><?=$list['status'];?></span></td>
                            <?php else : ?>
                              <td><span class="badge badge-danger"><?=$list['status'];?></span></td>
                            <?php endif;?> 
                            <td>
                              <a href="javascript:;" id="updateBarang" data-toggle="modal" data-target="#modalUpdateBarang" class="btn btn-info btn-xs"
                              data-id="<?=$list['id'];?>"
                              data-nama="<?=$list['nama_barang'];?>"
                              data-merk="<?=$list['merk'];?>"
                              ...
                              <a id="detailBarang" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modalDetail" 
                              data-daya="<?=$list['daya'];?>"
                              data-berat="<?=$list['berat'];?>"
                              data-catatan="<?=$list['catatan'];?>"
                              ...
                              <a id="delBarang" href="<?= base_url('stock/destroy/') . $list['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                            <?php endif;?>
                  ...
                  <form action="<?=base_url('stock/store');?>" method="post" class="needs-validation" novalidate="">
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input class="form-control" id="nama_barang" name="nama_barang" type="text" placeholder="Please fill in" required>
                         <div class="invalid-feedback">The field is required</div>
                        </div> 
                        <div class="col-md-4 mb-3">
                           <label for="merk" class="mb-0">Merk <em class="text-danger">*</em></label>
                          <input class="form-control" id="merk" name="merk" type="text" placeholder="Please fill in" required="">
                         <div class="invalid-feedback">The field is required</div>
                        </div>
                        <div class="col-md-4 mb-3">
                      ...
                      <div class="form-row">                        
                         <div class="col-md-4 mb-3">
                          <label for="daya" class="mb-0">Daya <small>( watt/VA )</small><em class="text-danger">*</em></label>
                          <input class="form-control" name="daya" id="daya" type="text" placeholder="Please fill in" required autocomplete="off">
                          <div class="invalid-feedback">The field is required</div>
                        </div>
                        <div class="col-md-4 mb-3">
                          <label for="berat" class="mb-0">Berat</label>
                          <input class="form-control" name="berat" id="berat" type="text" placeholder="Please fill in" autocomplete="off">
                          <div class="invalid-feedback">The field is required</div>
                        </div>
                         <div class="col-md-4 mb-3">
                      ...
                      <div class="form-row">
                         <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="catatan" id="catatan" rows="3" placeholder="Please fill in"></textarea>
                          </div>
                      </div>                    
        ...
        <!-- modal details -->
          <div class="modal fade bd-example-modal-lg" id="modalDetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Spesifikasi/Detail</h5>
                  <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
                <div id="modal-barang">
...
<!-- modal-update -->
          <div class="modal fade bd-example-modal-lg" id="modalUpdateBarang" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myLargeModalLabel">Form add data</h4>
